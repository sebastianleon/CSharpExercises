...
namespace CSharpExercises
{
    public static class Exercises
    {
        ...
        public static bool CanOpenCheckingAccount(int x)
        {
            if (x >= 18)
                return true;
            else
        ...
        {
            var fuckthis = fullName.Split(' ');
            string firstName = fuckthis[0];
            string lastName = fuckthis[1];
            return firstName;
        ...
        public static string ReverseStringHard(string x)
        {
        ...
        public static double ConvertKelvinToFahrenheit(double temp)
        {
            ...
            double newTemp = 1.79 * (temp - 273) + 32;
        ...
        //   11. Create a method called GetAverageEasy that accepts an array of integers and returns the average value as a double. (Using only built in functions)
                public static double GetAverageEasy(int [] people)
                        {
                            int sum = 0;
